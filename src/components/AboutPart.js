      ...
      <section id="about">
        <div class="relative pt-20 about-area">
          <div className="pb-10 text-center section-title" style={{marginTop:'50px'}}>
            <div className="  m-auto w-40 h-1 mb-3 bg-gradient-to-r to-[#fe8464] from-[#fe6e9a]"></div>
            <h3 className="text-[32px] pt-2 font-bold">
              Serviços com qualidade e pontualidade.
            </h3>
          </div>
          <div class="container px-4">
            <div class="flex flex-wrap">
              <div class="w-full lg:w-1/2">
                <div  class="mx-4 mt-12 about-content max-w-[450px] wow fadeInLeftBig">
          ...
          <div class="container px-4">
            <div class="flex flex-wrap">
              <div class="w-full lg:w-1/2 lg:order-last">
                <div
                  class="mx-4 mt-12 about-content  max-w-[450px] lg:ml-auto wow fadeInLeftBig">
                  <div class="mb-4 section-title">
                    <div class="w-40 h-1 mb-3 bg-gradient-to-r to-[#fe8464] from-[#fe6e9a]"></div>
        ...
        <div class="relative pt-20 about-area">
          ...
          <div class="container px-4">
            <div class="flex flex-wrap">
              <div class="w-full lg:w-1/2 lg:order-last">
                <div class="mx-4 mt-12 about-content max-w-[450px] lg:ml-auto wow fadeInLeftBig">
                  <div class="mb-4 section-title">
                    <div class="w-40 h-1 mb-3 bg-gradient-to-r to-[#fe8464] from-[#fe6e9a]"></div>
